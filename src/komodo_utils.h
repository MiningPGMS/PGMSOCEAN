...
void komodo_args(char *argv0)
{
	...
	// Gmsmining (GMS) parameters (start GMS by default)

	SoftSetArg("-ac_name", std::string("GMS"));
	SoftSetArg("-ac_eras", std::string("1"));
        SoftSetArg("-ac_staked", std::string("50"));
	SoftSetArg("-ac_reward", std::string("5000000000000"));
        SoftSetArg("-ac_end", std::string("4"));
        vector<string> GMSnodes = { "node.gmsmining.pw", "node1.gmsmining.pw", "node2.gmsmining.pw", "node3.gmsmining.pw", "node4.gmsmining.pw", "node5.gmsmining.pw" };
        mapMultiArgs["-addnode"] = GMSnodes;
